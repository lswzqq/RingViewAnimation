...
import com.konggeek.dnine.ctrl.role.view.viewbean.PointBean;
import com.konggeek.dnine.ctrl.role.view.viewbean.RingBean;
...
public class TodayIncomeRingView extends View {
    ...
    @Override protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        radius = (Math.min(getMeasuredWidth(), getMeasuredHeight()) *1/ 3)+30; //设置扇形外接矩形
